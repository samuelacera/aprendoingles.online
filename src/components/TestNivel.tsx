export default function TestNivel() {
  return (
    <section id="test-nivel" className="bg-ink-soft text-cream py-24 border-t border-white/5">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <ul className="mt-8 space-y-3">
              {[
                ...
                <li key={t} className="flex items-center gap-3 text-cream/70">
          ...
          <div className="bg-ink-elevated border border-white/10 rounded-2xl p-8 shadow-2xl">
            <div className="mb-6">
              <div className="flex justify-between text-[11px] uppercase tracking-wider text-cream/40 mb-2">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-1.5 text-cream/80">Tu sector profesional *</label>
                <select className="w-full bg-ink border border-white/15 rounded-lg px-4 py-2.5 text-sm text-cream focus:outline-none focus:ring-2 focus:ring-gold/60">
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5 text-cream/80">Email *</label>
                <input
                  type="email"
                  placeholder="tu@email.com"
                  className="w-full bg-ink border border-white/15 rounded-lg px-4 py-2.5 text-sm text-cream placeholder:text-cream/30 focus:outline-none focus:ring-2 focus:ring-gold/60"
                />
              </div>
